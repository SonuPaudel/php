...
<h2 class="text-4xl font-bold border-b-4 text-blue-300 border-black">Users</h2>

<div class="my-4 text-right">
    <a href="{{ route('user.create') }}" class="bg-blue-600 text-white rounded-lg px-3 py-2">Add Users</a>
</div>
